...
```{r DEG_summary}
if(file.exists("consensusDE/DEG_summary.tsv")){
...
if(file.exists("plots/raw_data_pca.png")){
  knitr::include_graphics("plots/raw_data_pca.png")
} else {
  cat("*No raw data PCA plot found.*\n\n")
}
```
...
if(file.exists("plots/corrected_normalised_data_pca.png")){
  knitr::include_graphics("plots/corrected_normalised_data_pca.png")
} else {
  cat("*No corrected and normalised PCA plot found.*\n\n")
}
```
